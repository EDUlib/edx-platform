...
(function (globals) {
  ...
  django.catalog = {
    ...
    "%(num_students)s student opened Subsection": [
      "%(num_students)s \u00e9tudiant a ouvert la sous-section", 
    ...
    "The email address you use to sign in. Communications from {platform_name} and your courses are sent to this address.  To change the email address, please contact {contact_email}.": "L'adresse email que vous utilisez pour vous connecter. Les communications de {platform_name} et de vos cours seront envoy\u00e9es \u00e0 cette adresse. Pour changer l'adresse email, veuillez contacter {contact_email}.", 
    ...
    "There was an error when trying to add learners:": [
      "Une erreur est survenue en tentant d'ajouter les apprenants :", 
    ...
    "Used": "Utilis\u00e9", 
    "Used in {count} unit": [
      "Utilis\u00e9 dans {count} unit\u00e9", 
      "Utilis\u00e9 dans {count} unit\u00e9s"
    ], 
    "User": "Utilisateur", 
